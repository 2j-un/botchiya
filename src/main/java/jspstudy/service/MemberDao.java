...
public class MemberDao {
	...
	public int insertMember(String memberId, String memberPwd, String memberName, String memberEmail,
		...
		String sql = "insert into b_member(MIDX,MEMBERID,MEMBERPWD,MEMBERNAME,MEMBEREMAIL,MEMBERGENDER,MEMBERADDR,MEMBERPHONE,MEMBERJUMIN,MEMBERHOBBY,MEMBERIP)"
	...
	public ArrayList<MemberVo> memberSelectAll() {
		...
		try {
			// Connection객체를 통해서 문자열을 쿼리화 시킨다
			pstmt = conn.prepareStatement(sql);
			...
			while (rs.next()) {
				...
				mv.setMembername(rs.getNString("memberName"));
