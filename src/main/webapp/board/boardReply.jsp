		...
		<body>
			...
			<input type="hidden" name="level_" value="<%=bv.getLevel_()%>">
				<table>
					...
					<tr>
						<td class="text-box" colspan="2"><input type = "text" name="subject" placeholder = "제목을 입력해주세요."></td>
					</tr>
					...
					<tr>
						<td class="text-box" colspan="2"> <input type = "text" name="content" placeholder = "내용을 입력해주세요."> </td>
					</tr>
					...
					<tr>
						<td class="text-box" colspan="2"><input type = "text" name = "writer" placeholder = "작성자를 입력해주세요."></td>
					</tr>
